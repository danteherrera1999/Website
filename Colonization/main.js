...
class structureElement extends layeredDropdown{
	...
	update(newData,updateHeader=false){
		if (this.data==null){this.structureBox.addStructure()};
...
class structureBox{
	...
	addStructure(){
		...
		this.structures.push(new structureElement(colony_data,container,structure,this));
	}
